<template>
  <div>
    ...
    <p>
      ...
      Per onderdeel staat er ook een bediening van de control aangegeven onder aan de betrefende pagina.
    </p>
    <div class="text-h6 q-mb-md">
      Openen dienst
    </div>
    <p>
      De diensten zijn opgeslagen met de *.vez extentie.<br>Afbeeldingen, teksten, video's worden alle in dit bestand mee opgeslagen.<br>
    ...
    <p>
      <ul>
        ...
        <li>
          ...
          Hier kan je een voorbeeld zien van het geselecteerde onderdeel uit de setlist van de linkerkolom.<br>
    ...
    <p>
      ...
      Op de plek van ➤ zie je nu een teller aftellen tot 0 waarna de mededeling weer automatisch verdwijnd. Door op deze teller te klikken kan je de mededeling eerder van het scherm af halen.
    </p>
  </div>
</template>
