<template>
  <div>
    ...
    <div class="text-h6 q-mb-md">
      Nieuw aftelklok toevoegen aan setlist:
    </div>
    <p>
      Via de <img src="../../assets/help/setlistadd.png">in het linker vak, onderin; kies je <img src="../../assets/help/setlistaddcountdown.png">
    </p>
    <p>
      Je zie nu onderstaand scherm verschijnen.<br>
      <img src="../../assets/help/addcountdowndialog.png"><br>
    ...
    <p>
      ...
      Een countdown bestaat uit 1 pagina.<br>
    </p>
    <div class="text-h6 q-mb-md">
